    ...
    for attempt in range(1, max_retries + 1):
        ...
        try:
            ...
            session = await client.sessions.create(
                api_timeout=900000,  # 15 минут в миллисекундах (максимум для hobby plan)
                use_proxy=False  # Steel прокси недоступна на hobby plan
            )
            ...
            # Примечание: set_viewport_size задаётся при создании контекста, здесь пропускаем
